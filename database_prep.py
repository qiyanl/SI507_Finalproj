...
def make_request_with_cache(city_name,state_name,cache):
    '''Check the cache for a saved result for the city and state pair. 
    ...
    -------
    dict
        the results of the query as a dictionary loaded from cache or from Yelp API
        JSON
    '''
...
def get_city_restaurant(city_name,state_name):
    '''This function is used to get the restaurants' detailed information
    of the city and state pair.
    Parameters
    ----------
    city_name: string
        The URL for the API endpoint
    ...
    list
        ...
        each dictionary contains one restaurant' detailed information. 
